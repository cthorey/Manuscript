...
its thickness  $d_c$, i.e $h\lld_c$,  we can neglect stretching  of the
...
reads
\begin{eqnarray}
  \overline{u}        =\frac{1}{\delta}\int_0^{\delta}AD's        &=&
...
For an isoviscous flow with $h_f\ll h \ll d_c$, in between the bending
