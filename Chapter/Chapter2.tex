...
For a small prewetting film thickness, i.e.  $h_f/H<<1$, the numerical
resolution  of the  equation  (\ref{C2-mainEq})  shows three  spreading
...
second regime, while the thickness tends to a constant, the radius evolves as $t^{1/2}$.
...
magma  as driving  the flow.   This  model shows  promising result  in
predicting  the  variety  of  shape  of  intermediate  scale  magmatic
intrusions;  from  the  dome  shape  of  laccolith  to  the  disk-like
...
terrestrial laccolith and low-slope lunar domes on the Moon and can be
an interesting tool to study intrusive magmatism on other planets.
