...
exemple, un édifice volcanique a donc tendance à dévier les dykes vers
sa   base  \citep{Watanabe:2002iw,Dahm:2000jb,Maccaferri:2011bd}.    A
...
évolution du champ de contrainte dépendait de la flotabilité du magma.
Notamment,  à l'échelle  de la  croûte,  la propension  d'un champ  de
contrainte  à  dévier  un  dyke devient  importante  seulement  si  la
contrainte  de   compression  domine  sur  la   flotabilité  du  magma
\citep{Menand:2010uq}.
...
de  préciser  l'évolution  post  océan  de  magma.   Ainsi,  après  la
cristallisation  complète  de  l'océan  magmatique,  des  instabilités
...
certainement induit de  la convection au sein du manteau  lunaire et a
engendré  de la  fusion partielle  formant des  magmas basaltiques  se
mettant en place en surface (KREEP)  et des roches plutoniques plus en
profondeur   au    sein   de   la   croûte    (riche   en   magnésium)
\citep{Shearer:2006gg}.   \citet{Taylor:1982hx}  ont  estimé  que  ces
roches riches en magnésium pourrait constituer $20\%$ des $60$ premier
kilomètres    de     la    croûte,    le    reste     étant    composé
d'anorthosite. Cependant, de nombreuses  études tendent à minimiser ce
nombre  \citep{Jolliff:2000vf}.  Cette  première  phase du  magmatisme
lunaire  prend vraisemblablement  fin au  début du  grand bombardement
tardif pour  laisser place  à une  seconde phase qui  voit la  mise en
place des mers lunaires. En effet, les mers lunaires sont probablement
le produit de la refonte de  cumulats beaucoup plus profond au sein du
manteau lunaire ($\sim 400$ km) \citep{Shearer:2006gg}.
...
moins épaisse  au niveau  des mers  lunaires. Elle  est principalement
composé d'anorthosites.

L'analyse des échantillons recueillis  par les missions Luna/Appolon a
aussi permis de mettre en évidence la possible présence de nombreuses
...
crôute de faible densité. C'est le  cas par exemple des mers lunaires,
qui se sont mises en place au sein de larges bassins d'impacts.




comme c'est la cas par exemple des  mers lunaires qui se sont mises en
place au  sein de  larges bassins d'impacts.   \citet{Head:1992bk} ont
estimé à $50$  fois plus importants les volumes de  magma mis en place
en profondeur que les volumes  éruptés en surface. Cependant, bien que
ce  rapport puisse  donner de  précieuses indications  sur l'évolution
thermique et magmatique de la lune  elle-même, il est de fait très peu
contraint et  la part intrusive  du magmatisme lunaire est  encore mal
connue.  La détection des déformations de surface induites par la mise
en place d'intrusions  magmatiques au sein de la  croûte apparaît donc
comme  une première  étape  visant à  la  meilleur caractérisation  du
magmatisme intrusif lunaire.
