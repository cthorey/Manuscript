...
can be expressed in term of $\xi$ (Appendix A) such that
\begin{equation}
  \Theta_s(r,t)=
  \begin{cases}
...
current which allows the steady expansion of the thermal anomaly.
\begin{figure}[h!]
  \begin{center}
    \graphicspath{ {/Users/thorey/Documents/These/Projet/Refroidissement/Skin_Model/Figure/Figure_Heating/} }
...
fit   the  simulations.    The   scaling  law   is   only  valid   for
$\Omega = O(1)$.  Indeed, it closely fits the simulations and both the
dependence  with the  Peclet number  $Pe$ and  the viscosity  contrast
vanishes    when    rescaling    by    $Pe^{1/4}\nu^{-1/8}$    (Figure
...
then stay hot  for a longueur period of time  and therefore, can reach
...
and the  model developed  in this chapter  seems more  appropriate for
...
to stay hot for a longueur period of time.  In particular, the thermal
